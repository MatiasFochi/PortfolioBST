...
function Descripcion(){
  return(
    <div className='container container-md row justify-content-md-center espaciado espaciado-lateral contenedor-principal-descripcion'>
      <div className='col col-sm-auto container-sm align-items-center text-start text-wrap fst-italic cv-contenedor espaciado espaciado-lateral sombreado contenedor-descripcion'>
